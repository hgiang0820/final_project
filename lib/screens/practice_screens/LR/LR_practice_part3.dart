...
class LRPracticePart3 extends StatefulWidget {
  final String testId;
  const LRPracticePart3({super.key, required this.testId});

  @override
  State<LRPracticePart3> createState() => LRPracticePart3State();
}

class LRPracticePart3State extends State<LRPracticePart3> {
  ...
  Future<void> _load() async {
    try {
      final partMeta = await repo.getPartMeta('practice_tests', widget.testId, 'part3');
      final qs = await repo.getQuestionsLR('practice_tests', widget.testId, 'part3');
      ...
      //   SnackBar(content: Text('Không tải được dữ liệu Part 3: $e')),
      // );
    }
  }
