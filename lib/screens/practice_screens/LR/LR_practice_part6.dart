...
class LRPracticePart6 extends StatefulWidget {
  final String testId;
  const LRPracticePart6({super.key, required this.testId});

  @override
  State<LRPracticePart6> createState() => LRPracticePart6State();
}

class LRPracticePart6State extends State<LRPracticePart6> {
  ...
  Future<void> _load() async {
    final qs = await repo.getQuestionsLR('practice_tests', widget.testId, 'part6');
    setState(() {
      questions = qs;
