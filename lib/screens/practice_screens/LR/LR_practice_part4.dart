...
class LRPracticePart4 extends StatefulWidget {
  final String testId;
  const LRPracticePart4({super.key, required this.testId});

  @override
  State<LRPracticePart4> createState() => LRPracticePart4State();
}

class LRPracticePart4State extends State<LRPracticePart4> {
  ...
  Future<void> _load() async {
    try {
      final partMeta = await repo.getPartMeta('practice_tests', widget.testId, 'part4');
      final qs = await repo.getQuestionsLR('practice_tests', widget.testId, 'part4');
      ...
      //   SnackBar(content: Text('Không tải được dữ liệu Part 4: $e')),
      // );
    }
  }
