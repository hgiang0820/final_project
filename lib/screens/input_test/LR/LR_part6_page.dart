...
class LRPart6Page extends StatefulWidget {
  final String testId;
  const LRPart6Page({super.key, required this.testId});

  @override
  State<LRPart6Page> createState() => LRPart6PageState();
}
...
class LRPart6PageState extends State<LRPart6Page> {
  ...
  Future<void> _load() async {
    final qs = await repo.getQuestionsLR('input_tests', widget.testId, 'part6');
    setState(() {
      questions = qs;
