...
class LRPart4Page extends StatefulWidget {
  final String testId;
  const LRPart4Page({super.key, required this.testId});

  @override
  State<LRPart4Page> createState() => LRPart4PageState();
}

class LRPart4PageState extends State<LRPart4Page> {
  ...
  Future<void> _load() async {
    try {
      final partMeta = await repo.getPartMeta('input_tests', widget.testId, 'part4');
      final qs = await repo.getQuestionsLR('input_tests', widget.testId, 'part4');
