...
Future<void> seedLRPracticePart4() async {
  ...
  Future<void> pushLessonLR({
    ...
    await lessonRef.set({
      ...
      'audioPath': 'LR/$levelId/part4/$lessonId/audio.wav',
  ...
  Future<void> pushLessonFull({
    ...
    await lessonRef.set({
      'type': 'Talks',
      'lessonName': lessonName,
      'audioPath': 'Full/$levelId/lis4/$lessonId/audio.wav',
      'questionCount': questions.length,
    }, SetOptions(merge: true));
  ...
  final p4Lv300L3 = <Map<String, dynamic>>[
    {
      ...
      'options': [
        'On your right after the elevators',
        'Behind the lobby',
        'Across the street',
        'On the left of elevators',
      ],
      'correctIndex': 0,
      'explain':
    ...
    },
    {
      ...
      'options': [
        'At the desk to the right of the doors',
        'At security outside',
        'In the basement',
        'At the café counter',
      ],
